const URL = "https://gogoanime.bid/";
const SEARCH = "https://gogoanime.bid/search.html?keyword";
...
const getLink = async (title) => {
	...
	let snip = res.slice(res.indexOf("<iframe"), res.indexOf("</iframe>"));
	snip = snip.slice(snip.indexOf("//gogohd"), snip.indexOf('" '));
